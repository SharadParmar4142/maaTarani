                  ...
                  <div key={order.id} className="rounded-lg border border-gray-200 p-4">
                    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="text-sm text-gray-600">
                        <p>Total: ₹{Number(order.total || 0).toLocaleString('en-IN')}</p>
                    ...
                    {isExpanded && (
                      <div className="mt-5 rounded-xl border border-gray-200 bg-white p-6">
                        ...
                        <div className="grid gap-2 text-sm text-gray-700 md:grid-cols-2">
                          ...
                          <p><span className="font-semibold">Sub Total:</span> ₹{Number(order.subTotal || 0).toLocaleString('en-IN')}</p>
                          <p><span className="font-semibold">Total:</span> ₹{Number(order.total || 0).toLocaleString('en-IN')}</p>
